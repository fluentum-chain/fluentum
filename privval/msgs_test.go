...
import (
	...
	privproto "github.com/fluentum-chain/fluentum/proto/tendermint/privval"
...
func TestPrivvalVectors(t *testing.T) {
	...
	testCases := []struct {
		...
		{"pubKey response with error", &privproto.PubKeyResponse{PubKey: cosmosproto.PublicKey{}, Error: remoteError}, "12140a0012100801120c697427732061206572726f72"},
