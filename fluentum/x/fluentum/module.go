...
func (am AppModule) BeginBlock(_ sdk.Context, _ abci.RequestBeginBlockRequest) {}

// EndBlock executes all ABCI EndBlock logic respective to the fluentum module. It
// returns no validator updates.
func (am AppModule) EndBlock(_ sdk.Context, _ abci.RequestEndBlockRequest) []abci.ValidatorUpdate {
	return []abci.ValidatorUpdate{}
}
