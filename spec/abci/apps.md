...
As of Cosmos SDK v0.50.x and CometBFT v0.38.x, DeliverTx is replaced by FinalizeBlock. Applications must implement block-level transaction processing using FinalizeBlock.
