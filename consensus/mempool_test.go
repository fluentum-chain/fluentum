...
func TestMempoolRmBadTx(t *testing.T) {
	...
	resDeliver := app.DeliverTx(abci.RequestFinalizeBlock{Tx: txBytes})
...
func (app *CounterApplication) DeliverTx(req abci.RequestFinalizeBlock) abci.ResponseDeliverTx {
