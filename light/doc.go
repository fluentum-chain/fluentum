...
https://github.com/fluentum-chain/fluentum/blob/v0.34.x/spec/consensus/light-client/verification.md
for details.
...
for usage example.
Or see
https://github.com/fluentum-chain/fluentum/tree/v0.34.x/spec/consensus/light-client
for the full spec
*/
package light
